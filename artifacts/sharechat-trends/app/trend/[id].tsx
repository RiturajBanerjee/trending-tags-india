...
export default function TrendDetail() {
  ...
  const trend = useMemo(() => getTrendById(id ?? ""), [id]);
  ...
  const bottomInset =
    Platform.OS === "web" ? insets.bottom + 110 : insets.bottom + 90;
      ...
      >
            ...
            <View style={styles.heroMeta}>
              ...
              <View style={styles.heroMetaItem}>
                ...
                <Text style={styles.heroMetaText}>
                  {trend.startedHoursAgo} घंटे पहले शुरू
                </Text>
              </View>
            </View>
          </View>
        ...
        <View style={styles.body}>
            ...
            <View style={styles.statsRow}>
              <View style={styles.statBlock}>
                ...
                <View style={{ marginTop: 6 }}>
                  <HeatBar heat={trend.heat} width={60} />
                </View>
              </View>
              <View
                style={[
          ...
          <View style={styles.section}>
            ...
            >
              मुख्य स्रोत: {sourceLabel(trend.primarySource)}
            </Text>
          </View>
